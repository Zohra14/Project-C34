...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   blower.position(280,300)
   blower.size(120,120)
   blower.mouseClicked(airBlow)

 
   star1=createSprite(320,90,20,20)
   star1.addImage("star",star_img)
   star1.scale = 0.02

   star2=createSprite(100,320,20,20)
   star2.addImage("star",star_img)
   star2.scale = 0.02

   star_display=createSprite(50,20,30,30)
   star_display.scale=0.2
   star_display.addImage("empty",empty_star)
   star_display.addImage("onestar",one_star)
...
function draw() 
{
  ...
  if(collide(fruit,star1,20)==true) {
    star1.visible=false
    star_display.changeImage("onestar",one_star)
  }

  if(collide(fruit,star2,20)==true) {
    star2.visible=false
    star_display.changeImage("two",two_star)
  }
